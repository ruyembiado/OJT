    ...
    <div class="row mx-auto mt-2">
        <form method="post" action="../actions/update_profile.php">
            <div class="form-group text-start mb-3">
                ...
                <div class="d-flex">
                    <i class="fa fa-user position-absolute ms-2 pe-1 border-end align-self-center text-light"></i>
                    <input class="form-control text-indent bg-dark text-light" name="username"
                        value="<?php echo $_SESSION['username']; ?>" placeholder="Enter your new username" />
